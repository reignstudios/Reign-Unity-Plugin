...
public class GooglePlay_InAppPurchaseNative implements ReignActivityCallbacks
{
	...
	public static void Init(final String base64Key, String itemSKUs, String itemTypes, final boolean testing)
	{
		...
		ReignUnityActivity.ReignContext.runOnUiThread(new Runnable()
		{
			public void run()
			{
				helper = new IabHelper(ReignUnityActivity.ReignContext, base64Key);
	...
	public static void BuyApp(final String sku)
	{
		...
		ReignUnityActivity.ReignContext.runOnUiThread(new Runnable()
		{
			public void run()
			{
				try
				{
					helper.launchPurchaseFlow(ReignUnityActivity.ReignContext, sku, BuyIntentID, mPurchaseFinishedListener, "");
				}
				catch (Exception e)
				{
