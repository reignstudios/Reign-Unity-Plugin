	...
	public static void CreateAd(final String appKey, final boolean testing, final boolean visible, final int gravity, final int adSize, final int refreshSec, final String adID)
	{
		...
		ReignUnityActivity.ReignContext.runOnUiThread(new Runnable()
		{
			public void run()
			{
				...
				AdLayout adView = new AdLayout(ReignUnityActivity.ReignContext, currentAdSize);// <<<<<<<< NEED TO ADD THESE
				...
				ReignUnityActivity.ContentView.addView(adView, adViewParams);
	...
	public static void Dispose(final String adID)
	{
		...
		ReignUnityActivity.ReignContext.runOnUiThread(new Runnable()
		{
			public void run()
			{
				...
				ReignUnityActivity.ContentView.removeView(ad.Ad);
				ad.Ad.destroy();
			}
		});
	}
