...
{
	public class GooglePlay_InAppPurchasePlugin : IInAppPurchasePlugin
	{
		...
		public GooglePlay_InAppPurchasePlugin(InAppPurchaseDesc desc, InAppPurchaseCreatedCallbackMethod createdCallback)
		{
		...
		~GooglePlay_InAppPurchasePlugin()
		{
			if (native != null)
			{
				native.Dispose();
