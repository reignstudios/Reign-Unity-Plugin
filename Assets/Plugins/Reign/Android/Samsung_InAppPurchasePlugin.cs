...
{
	public class Samsung_InAppPurchasePlugin : IInAppPurchasePlugin
	{
		...
		public Samsung_InAppPurchasePlugin(InAppPurchaseDesc desc, InAppPurchaseCreatedCallbackMethod createdCallback)
		{
